...
Так же стоит выдавать вопросы тематик(тегов), которые пользователь раньше не смотрел, но выдавать их ниже в списке. 
...
| ------ | ------- | ---------------------------------- | ----- | ------- | ------- | ------------------ |
| nginx  | own     | 2x6430/4x8GB/1xNVMe256Gb/2x10Gb/s  | 64    | 4       | $10'000 | $167               |
| Auth   | own     | 2x6430/4x8GB/1xNVMe256Gb/2x10Gb/s  | 64    | 2       | $10'000 | $167               |
